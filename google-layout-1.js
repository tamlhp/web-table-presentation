...
//            target.innerText = "more";
    ...
    var buildTable = function(table, keyword, hide){
        ...
        var result = ('<div class="google-table">' +
            ...
            '<div class="google-show-more" style="display: none">Show <span class="more">{3}</span> ({4} rows / {5} columns total) - Import data</div>' +
            ...
            .format((isUrl(table.url)?"":"http://") + table.url,
                ...
                hide?"more":"less",
                numberToString(rows.length + Math.floor(Math.random() * 20)),
